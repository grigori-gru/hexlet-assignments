...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        assertThat(text.length()).isEqualTo(expectedStr.length());
        assertThat(text.charAt(1)).isEqualTo(expectedStr.charAt(1));
        assertThat(text.toString()).isEqualTo(expectedStr.toString());
    }
